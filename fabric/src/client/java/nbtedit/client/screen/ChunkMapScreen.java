...
public class ChunkMapScreen extends Screen implements ReadOnly {
	...
	protected void init() {
		...
		this.openButton = actions.addChild(new IconButton(Icons.OPEN, Component.translatable("nbtedit.button.open"), button -> this.openSelected()));
		this.listButton = actions.addChild(new IconButton(Icons.LIST, Component.translatable("nbtedit.button.list"), button -> this.openList()));
